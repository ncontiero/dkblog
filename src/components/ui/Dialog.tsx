...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      className={cn(
        `
          fixed inset-0 z-50 bg-background/80 backdrop-blur-xs data-[state=closed]:animate-out data-[state=closed]:fade-out-0
  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        className={cn(
          `
            fixed top-[50%] left-[50%] z-50 grid w-full max-w-lg translate-[-50%] gap-4 border bg-background p-6 shadow-lg
            ...
            data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 data-[state=open]:slide-in-from-left-1/2
