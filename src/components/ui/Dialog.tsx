    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        `
          ...
          bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=open]:fade-in-0
          ...
          data-[state=closed]:slide-out-to-top-[48%] sm:rounded-lg md:w-full
        `,
        className,
      )}
      {...props}
